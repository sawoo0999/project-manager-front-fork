          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="flex flex-col justify-center space-y-8 md:pl-20 lg:pl-0 lg:w-[3]">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <Link
                  to="/login"
                  className="inline-flex items-center justify-center rounded-lg bg-primary px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/80"
                >
                  로그인하러 가기
                ...
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center rounded-lg border border-primary bg-white px-8 py-3 text-sm font-medium transition-colors hover:bg-green-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/90"
                >
                  회원가입하러 가기
                </Link>
              </div>
      ...
      <section className="px-4 py-16 md:px-8 lg:py-24">
        <div className="container mx-auto xl:max-w-[1080px]">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 ">
            ...
            <div className="group rounded-lg border p-6 transition-all hover:border-primary hover:shadow-lg">
              <BarChart2 className="mb-4 h-8 w-8 text-primary" />
            ...
            <div className="group rounded-lg border p-6 transition-all hover:border-primary hover:shadow-lg">
              <Users2 className="mb-4 h-8 w-8 text-primary" />
